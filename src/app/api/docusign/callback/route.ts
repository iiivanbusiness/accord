...
export async function GET(req: Request) {
  ...
  try {
    ...
    if (!(await isValidOAuthState("docusign", url.searchParams.get("state"), workspaceId))) {
      return NextResponse.redirect(new URL("/settings?error=docusign_invalid_state", req.url));
    }
